...
- (UISearchBar *)searchBar{
    if (!_searchBar) {
        ...
        [_searchBar.layer setBorderColor:[UIColor colorWithRed:204.0/255 green:204.0/255 blue:204.0/255 alpha:1].CGColor];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if (!label) {
        ...
        [label setTextColor:[UIColor colorWithRed:29.0/255 green:29.0/255 blue:29.0/255 alpha:1]];
